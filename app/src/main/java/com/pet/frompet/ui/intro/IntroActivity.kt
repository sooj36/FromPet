...
import com.pet.frompet.databinding.ActivityIntroBinding
import com.pet.frompet.ui.login.MemberInfoActivity
...
class IntroActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pageItemList.add(PageItem(R.color.warm_blue, R.drawable.loginprofile2, "반려동물을 위한 "))
